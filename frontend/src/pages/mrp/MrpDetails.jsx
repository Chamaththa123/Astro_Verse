    ...
    <>
      ...
      >
        <Card className="mx-auto w-full p-5 rounded-sm h-[90vh] overflow-y-auto scrollbar-y-style">
          ...
          <div className="md:w-[50%]"><span className="font-inter font-semibold">Rover Landing Date : </span><span className="font-inter font-medium"> {mrp.rover.landing_date}</span></div>
          <div className="md:w-[50%]"><span className="font-inter font-semibold">Rover Launch Date : </span><span className="font-inter font-medium"> {mrp.rover.launch_date}</span></div>
          </div>
          <div className="md:flex md:justify-between text-left md:mt-3">
          <div className="md:w-[50%]"><span className="font-inter font-semibold">Rover Status : </span><span className="font-inter font-medium"> {mrp.rover.status}</span></div>
          <div className="md:w-[50%]"><span className="font-inter font-semibold">Rover Max Sol : </span><span className="font-inter font-medium"> {mrp.rover.max_sol}</span></div>
          </div>

          <div className="md:flex md:justify-between text-left md:mt-3">
          <div className="md:w-[50%]"><span className="font-inter font-semibold">Rover Max Date : </span><span className="font-inter font-medium"> {mrp.rover.max_date}</span></div>
          <div className="md:w-[50%]"><span className="font-inter font-semibold">Rover Total Photos : </span><span className="font-inter font-medium"> {mrp.rover.total_photos}</span></div>
          </div>
